...
export default class App extends React.Component {
  ...
  updateDimensions() {
    let deviceWidth = Dimensions.get('window').width
    this.setStateAsync({deviceWidth: deviceWidth})
  }
  ...
  render() {
    ...
    return (
        <Wrapper>
              ...
              <HeaderGroup>
                <HeaderLogo>
                  <svg viewBox="0 0 645.6 119" preserveAspectRatio="none">
                    <path className="st0" d="M101,54L101,54c-1.7,0-3-1.3-3-3V3c0-1.6,1.3-3,3-3l0,0c1.7,0,3,1.3,3,3v48C104,52.7,102.7,54,101,54z"/>
                    <path className="st0" d="M85,54L85,54c-1.7,0-3-1.3-3-3V13c0-1.6,1.3-3,3-3l0,0c1.7,0,3,1.3,3,3v38C88,52.7,86.7,54,85,54z"/>
                    <path className="st0" d="M69,54L69,54c-1.7,0-3-1.3-3-3V25c0-1.6,1.3-3,3-3l0,0c1.7,0,3,1.3,3,3v26C72,52.7,70.7,54,69,54z"/>
                    <path className="st0" d="M53,54L53,54c-1.7,0-3-1.3-3-3V37c0-1.6,1.3-3,3-3h0c1.6,0,3,1.3,3,3v14C56,52.7,54.7,54,53,54z"/>
                    <path className="st1" d="M37,100L37,100c-1.7,0-3-1.3-3-3V79c0-1.7,1.3-3,3-3h0c1.6,0,3,1.3,3,3v18C40,98.7,38.7,100,37,100z"/>
                    <path className="st1" d="M21,119L21,119c-1.7,0-3-1.3-3-3V79c0-1.7,1.3-3,3-3h0c1.6,0,3,1.3,3,3v37C24,117.7,22.7,119,21,119z"/>
                    <path className="st2" d="M5,106L5,106c-1.7,0-3-1.3-3-3V79c0-1.7,1.3-3,3-3h0c1.6,0,3,1.3,3,3v24C8,104.7,6.7,106,5,106z"/>
                    <circle className="st3" cx="5" cy="65" r="5"/>
                    <circle className="st3" cx="21" cy="65" r="5"/>
                    <circle className="st3" cx="37" cy="65" r="5"/>
                    <circle className="st4" cx="53" cy="65" r="5"/>
                    <circle className="st4" cx="69" cy="65" r="5"/>
                    <circle className="st3" cx="85" cy="65" r="5"/>
                    <circle className="st3" cx="101" cy="65" r="5"/>
                    <g>
                      <path className="st5" d="M151.5,38.6c-0.7-0.9-1.6-1.6-2.6-2.1c-1-0.5-2.2-0.7-3.5-0.7c-0.6,0-1.2,0.1-1.9,0.2
                      ...
                      <path className="st5" d="M205.4,44.3c0,2.2-0.3,4.1-0.8,5.8c-0.5,1.7-1.1,3.1-1.9,4.4c-0.8,1.2-1.6,2.3-2.4,3.1c-0.9,0.9-1.6,1.5-2.4,2
                      ...
                      <path className="st5" d="M246.9,58.9c-0.9,1.8-2,3.3-3.4,4.5s-3.1,2.2-5,2.9c-1.9,0.7-4.2,1-6.7,1c-2.2,0-4.2-0.3-6-0.8
                      ...
                      <path className="st5" d="M260.6,66.5l6.5-36.8h23.6l-1.3,7.4h-15.3l-1.2,7.1h14.6l-1.2,7h-14.6l-1.4,7.9H287l-1.3,7.4H260.6z"/>
                      <path className="st5" d="M298,66.5l6.5-36.8H328l-1.3,7.4h-15.3l-1.2,7.1h14.6l-1.2,7h-14.6l-1.4,7.9h16.7l-1.3,7.4H298z"/>
                      <path className="st5" d="M332.8,66.5l1.3-7.5l21.4-21.9h-16l1.3-7.4h27.2l-1.2,7L345.1,59h18.3l-1.4,7.5H332.8z"/>
                      <path className="st5" d="M374.4,66.5l6.5-36.8h23.6l-1.3,7.4h-15.3l-1.2,7.1h14.6l-1.2,7h-14.6l-1.4,7.9h16.7l-1.3,7.4H374.4z"/>
                      <path className="st5" d="M421.3,61.6c0,0.7-0.1,1.4-0.4,2s-0.6,1.2-1.1,1.7c-0.5,0.5-1,0.9-1.6,1.1c-0.6,0.3-1.3,0.4-2.1,0.4
                      ...
                      <path className="st5" d="M469.4,66.5h-8.6l-2.5-25.2h-0.2l-12.2,25.2h-8.6l-3.2-36.8h9.2l1.1,24.8h0.2l11.4-24.8h8.9l2,24.8h0.2
                        l11-24.8h9.1L469.4,66.5z"/>
                      <path className="st5" d="M515,66.5l-1.2-7.3h-14.2l-4.4,7.3h-9.9l23.5-36.8h8.4l7,36.8H515z M511,39.1l-7.7,13.1h9.6L511,39.1z"/>
                      <path className="st5" d="M551.2,37.1L546,66.5h-8.6l5.1-29.4h-10.3l1.4-7.4h29l-1.3,7.4H551.2z"/>
                      <path className="st5" d="M598,61.4c-0.7,0.8-1.6,1.6-2.5,2.3c-1,0.7-2,1.4-3.3,2c-1.2,0.6-2.6,1-4.1,1.4c-1.5,0.3-3.1,0.5-4.9,0.5
                      ...
                      <path className="st5" d="M630.5,66.5l2.7-15.5h-14.3l-2.8,15.5h-8.6l6.5-36.8h8.6l-2.5,14h14.4l2.4-14h8.7l-6.5,36.8H630.5z"/>
                    </g>
                  </svg>
          ...
          <Settings style={{width:(this.state.settings) ? '300px' : '0px'}}>
            <SettingsWrap>
              SettingsWrap
            </SettingsWrap>
          </Settings>
